...
const I18N = {
  en: {
    ...
    "meta.desc": "interference is the open-source terminal coding agent powered by Agentic SWE, a separate behavior framework for gates, scoped capabilities, and evidence-backed completion.",
    "og.title": "interference — the open-source terminal coding agent",
    "og.desc": "An Italian open-source terminal coding agent with Agentic SWE at its behavioral core.",
    ...
    "hero.lede": "interference reads your code, edits files and runs commands through an agentic loop. Every turn passes through the open-source Agentic SWE behavior framework, with code-enforced permissions and a read-only Plan mode.",
    ...
    "framework.eyebrow": "/ 01 — open behavior framework",
    "framework.title": "Prompts can suggest. The framework decides what happens next.",
    "framework.lede": "Every primary turn is evaluated by Agentic SWE — the separate open-source protocol and runtime at the heart of interference. It classifies intent, opens setup and planning gates, scopes capabilities, and requires host evidence before completion.",
    "framework.cta": "Explore Agentic SWE on GitHub ↗",
    "framework.meta": "Protocol 1.1 · MIT · separate repository",
    "framework.trace_intent": "intent",
    "framework.trace_gates": "gates",
    "framework.trace_access": "access",
    "framework.trace_evidence": "evidence",
    "framework.trace_complete": "complete",
    "framework.gates_title": "Gates before action",
    "framework.gates_desc": "Non-trivial work cannot skip repository setup or planning. Complex questions remain read-only when no mutation was requested.",
    "framework.access_title": "Deny wins",
    "framework.access_desc": "The model may describe intent, but it cannot grant access. Agentic SWE and interference can only narrow the toolset.",
    "framework.evidence_title": "Evidence before done",
    "framework.evidence_desc": "Only successful redacted host events satisfy hard criteria. A failed test never becomes proof of validation.",
    "framework.core_owns": "owns behavior: classify · gate · route · verify",
    "framework.host_owns": "owns execution: models · tools · permissions · sessions · TUI",
    "framework.cycle": "<strong>AGENTS.md</strong> → <strong>gates</strong> → <strong>scoped tools</strong> → <strong>evidence</strong> — behavior that survives the chat",
  ...
  it: {
    ...
    "meta.desc": "interference è l'agente di coding open source da terminale basato su Agentic SWE, un framework separato per gate, capability mirate e completamento con evidenze.",
    "og.title": "interference — l'agente di coding open-source da terminale",
    "og.desc": "Un agente di coding open source italiano da terminale con Agentic SWE al cuore del comportamento.",
    ...
    "hero.lede": "interference legge il tuo codice, modifica file ed esegue comandi attraverso un agent loop. Ogni turno passa dal framework comportamentale open source Agentic SWE, con permessi applicati nel codice e modalità Plan in sola lettura.",
    ...
    "framework.eyebrow": "/ 01 — framework comportamentale open source",
    "framework.title": "I prompt possono suggerire. Il framework decide cosa succede dopo.",
    "framework.lede": "Ogni turno principale viene valutato da Agentic SWE — il protocollo e runtime open source separato al cuore di interference. Classifica l'intento, apre i gate di setup e pianificazione, limita le capability e richiede evidenze host prima del completamento.",
    "framework.cta": "Esplora Agentic SWE su GitHub ↗",
    "framework.meta": "Protocol 1.1 · MIT · repository separata",
    "framework.trace_intent": "intento",
    "framework.trace_gates": "gate",
    "framework.trace_access": "accesso",
    "framework.trace_evidence": "evidenze",
    "framework.trace_complete": "completo",
    "framework.gates_title": "Gate prima dell'azione",
    "framework.gates_desc": "Il lavoro non banale non può saltare setup o pianificazione. Le domande complesse restano in sola lettura quando non chiedono modifiche.",
    "framework.access_title": "Il deny prevale",
    "framework.access_desc": "Il modello può descrivere l'intento, ma non può concedere accesso. Agentic SWE e interference possono solo restringere i tool.",
    "framework.evidence_title": "Evidenze prima del fatto",
    "framework.evidence_desc": "Solo eventi host riusciti e redatti soddisfano i criteri hard. Un test fallito non diventa mai prova di validazione.",
    "framework.core_owns": "possiede il comportamento: classifica · gate · instrada · verifica",
    "framework.host_owns": "possiede l'esecuzione: modelli · tool · permessi · sessioni · TUI",
    "framework.cycle": "<strong>AGENTS.md</strong> → <strong>gate</strong> → <strong>tool mirati</strong> → <strong>evidenze</strong> — comportamento che sopravvive alla chat",
