...
const I18N = {
  en: {
    ...
    "how.step2_desc": "<code>read · ls · glob · grep</code> to explore, <code>write · edit · bash</code> to act — multi-step, streamed live.",
  ...
  it: {
    ...
    "how.step2_desc": "<code>read · ls · glob · grep</code> per esplorare, <code>write · edit · bash</code> per agire — multi-step, in streaming live.",
